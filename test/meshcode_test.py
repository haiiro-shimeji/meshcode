...
class TestMeshCode(unittest.TestCase):
    ...
    def testFromPoint(self):
        ...
        for f in [
            ...
            [35.68855064, 139.70156908, Level.QUOTER, "5339452631"],
            [35.68853321, 139.70468581, Level.QUOTER, "5339452632"],
            [35.69062889, 139.70156372, Level.QUOTER, "5339452633"],
            [35.69070295, 139.70476627, Level.QUOTER, "5339452634"],
    ...
    def testBasePointFromCode(self):
        ...
        for f in [
            ...
            ["5237441044", Level.QUOTER, 35.014583333333334, 137.509375],
    ...
    def testPolygon(self):
        ...
        for f in [
            ...
            ["5237441044", Level.QUOTER, 137.509375, 35.014583333333334, 137.51250000000002, 35.016666666666666],
